...
function initScrollAnimations() {
  ...
  document
    .querySelectorAll(".projects-grid, .skills-grid, .insights-grid")
    .forEach((grid) => {
...
function initThemeToggle() {
  ...
  // Set initial state from FOUC script
  updateToggleState();
  ...
  // Listen for OS theme changes (only if no localStorage override)
  window
